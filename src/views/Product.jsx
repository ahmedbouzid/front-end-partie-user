    ...
    <div className="container">
      ...
      <div className="row">
          ...
          <div className="product__item">
            <div className="product__item__pic set-bg" 
             style={{backgroundImage:`url(${
                process.env.PUBLIC_URL+"img/product/related/rp-1.jpg"})`}}
            >
        ...
        <div className="col-lg-3 col-md-4 col-sm-6">
          <div className="product__item">
            <div className="product__item__pic set-bg"  style={{backgroundImage:`url(${
                process.env.PUBLIC_URL+"img/product/related/rp-2.jpg"})`}}>
              <ul className="product__hover">
        ...
        <div className="col-lg-3 col-md-4 col-sm-6">
          <div className="product__item">
            <div className="product__item__pic set-bg"  style={{backgroundImage:`url(${
                process.env.PUBLIC_URL+"img/product/related/rp-3.jpg"})`}}>
        ...
        <div className="col-lg-3 col-md-4 col-sm-6">
          <div className="product__item">
            <div className="product__item__pic set-bg"  style={{backgroundImage:`url(${
                process.env.PUBLIC_URL+"img/product/related/rp-4.jpg"})`}}>
              <ul className="product__hover">
